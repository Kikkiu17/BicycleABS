...
#define HALL_IN_Pin GPIO_PIN_2
#define HALL_IN_GPIO_Port GPIOA
#define FRONT_LIGHTS_Pin GPIO_PIN_5
#define FRONT_LIGHTS_GPIO_Port GPIOA
#define BAT_ADC_Pin GPIO_PIN_0
#define BAT_ADC_GPIO_Port GPIOB
#define BRAKE_LIGHT_Pin GPIO_PIN_8
#define BRAKE_LIGHT_GPIO_Port GPIOA
#define SERVO_OUT_Pin GPIO_PIN_9
